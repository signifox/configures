...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (doom-themes powerline flycheck-rust cargo rust-mode window-numbering doom-modeline rainbow-mode darkroom hydra dracula-theme company-irony-c-headers editorconfig ace-window ibuffer-sidebar imenu-anywhere hl-todo yasnippet clang-format avy dired-sidebar yasnippet-snippets flycheck company-irony irony company smex flx magit counsel-gtags counsel swiper ivy evil-leader evil use-package)))
