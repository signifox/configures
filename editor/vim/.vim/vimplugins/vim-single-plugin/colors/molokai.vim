...
" Generated by http://bytefluent.com/vivify 2012-09-27
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi SpecialComment guifg=#465457 guibg=#ff0087 guisp=#ff0087 gui=bold,underline ctermfg=240 ctermbg=198 cterm=bold,underline
hi Typedef guifg=#c00000 guibg=#afd7ff guisp=#afd7ff gui=NONE ctermfg=1 ctermbg=153 cterm=NONE
...
hi Include guifg=#005fff guibg=NONE guisp=NONE gui=NONE ctermfg=27 ctermbg=NONE cterm=NONE
hi Float guifg=#AE81FF guibg=NONE guisp=NONE gui=NONE ctermfg=141 ctermbg=NONE cterm=NONE
hi StatusLineNC guifg=#808080 guibg=#afffff guisp=#afffff gui=NONE ctermfg=8 ctermbg=159 cterm=NONE
"hi CTagsMember -- no settings --
hi NonText guifg=#c0c0c0 guibg=#3B3A32 guisp=#3B3A32 gui=NONE ctermfg=7 ctermbg=237 cterm=NONE
...
"hi Normal guifg=#005fff guibg=#272822 guisp=#272822 gui=NONE ctermfg=27 ctermbg=235 cterm=NONE
hi Normal guifg=#c0c0c0 guibg=#000040 guisp=#272822 gui=NONE ctermfg=gray ctermbg=black cterm=NONE
hi Label guifg=#E6DB74 guibg=NONE guisp=NONE gui=NONE ctermfg=185 ctermbg=NONE cterm=NONE
"hi CTagsImport -- no settings --
hi PMenuSel guifg=#0000d7 guibg=#87afff guisp=#87afff gui=bold ctermfg=20 ctermbg=111 cterm=bold
...
hi Comment guifg=#ff5f00 guibg=NONE guisp=NONE gui=italic ctermfg=202 ctermbg=NONE cterm=NONE
...
hi Union guifg=#ffd700 guibg=NONE guisp=NONE gui=underline ctermfg=220 ctermbg=NONE cterm=underline
...
hi PreProc guifg=#00ff87 guibg=NONE guisp=NONE gui=NONE ctermfg=48 ctermbg=NONE cterm=NONE
hi EnumerationName guifg=#c00000 guibg=NONE guisp=NONE gui=underline ctermfg=1 ctermbg=NONE cterm=underline
...
hi Error guifg=#c00000 guibg=#d7875f guisp=#d7875f gui=NONE ctermfg=1 ctermbg=173 cterm=NONE
...
hi String guifg=#ffaf00 guibg=NONE guisp=NONE gui=NONE ctermfg=214 ctermbg=NONE cterm=NONE
...
hi LocalVariable guifg=#d700af guibg=NONE guisp=NONE gui=italic ctermfg=163 ctermbg=NONE cterm=NONE
...
hi Macro guifg=#ff87af guibg=#444444 guisp=#444444 gui=bold,italic ctermfg=211 ctermbg=238 cterm=bold
